        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                      ...
                      <a href="{{URL::to('/contact')}}"><button class="btn btn-outline-danger" >Contact</button></a>
